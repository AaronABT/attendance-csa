...
if (isset($_POST['save'])) {
  ...
  $query = $conn_pdo->prepare("SELECT * FROM tblclass WHERE className = :className");
  ...
  if ($ret) {
    ...
    $query = $conn_pdo->prepare("INSERT INTO tblclass(className) VALUES (:className)");
    $query->bindParam(':className', $className);
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
  ...
  $query = $conn_pdo->prepare("SELECT * FROM tblclass WHERE Id = :Id");
  ...
  if (isset($_POST['update'])) {
    ...
    $query = $conn_pdo->prepare("UPDATE tblclass SET className = :className WHERE Id = :Id");
    $query->bindParam(':className', $className);
    $query->bindParam(':Id', $Id);
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete") {
  ...
  $query = $conn_pdo->prepare("DELETE FROM tblclass WHERE Id = :Id");
  $query->bindParam(':Id', $Id);
