                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        tblstudents.firstName,tblstudents.lastName,tblstudents.Wing,tblstudents.admissionNumber, tblevents.event_name
                        FROM tblattendance
...
link.download = `studentAttendnace ${new Date().toLocaleDateString()}.xlsx`;
link.click();
