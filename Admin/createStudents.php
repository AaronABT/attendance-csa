...
if(isset($_POST['save'])){
  ...
  $eligibleForCredit = $_POST["eligibleForCredit"];
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,Wing,admissionNumber,password,classId,classArmId,dateCreated, credit, email) 
    value('$firstName','$lastName','$Wing','$admissionNumber','12345','$classId','$classArmId','$dateCreated', $eligibleForCredit, $email)");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    Wing='$Wing', admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId', email='$email'
    where Id='$Id'");
            if ($query) {
  ...
  <link href="css/ruang-admin.min.css" rel="stylesheet">
   ...
   <script>
    function classArmDropdown(str) {
      console.log("ajaxClassArms2.php?cid="+str);
    if (str == "") {
...
<body id="page-top">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                      <!-- option that says Eligible for credit and an options tag of YES and No with value 1 and 0 -->
                        <div class="col-xl-6">
                        <label class="form-control-label">Eligible for credit<span class="text-danger ml-2">*</span></label>
                        <select required name="eligibleForCredit" id="eligibleForCredit" class="form-control mb-3">
                     ...
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <!-- options tag -->
                        <label class="form-control-label">Select Wing<span class="text-danger ml-2">*</span></label>
                        <select required id="wing_selection" name="Wing" class="form-control mb-3">
                          <option>Drishti</option>
                          <option>Disha</option>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblstudents.email,tblclass.className,tblclassdivision.classArmName,tblclassdivision.Id AS classArmId,tblstudents.firstName,
  ...
  <script>
    ...
    $("#eligibleForCredit").on("change", (e) => {
      creditCheck()
    })

    const creditCheck = () => {
      if ($("#eligibleForCredit").val() == "1") {
        $("#wing_selection").attr("disabled", true)
        $("#wing_selection").val("-- Disabled --")
      } else {
        $("#wing_selection").attr("disabled", false)
      }
    }
