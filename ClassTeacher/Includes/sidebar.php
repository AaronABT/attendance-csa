<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="mapStudentToEvent.php">Map Students to Event</a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Manage Credits</h6>
  ...
  <li class="nav-item">
    ...
    <div id="collapseBootstrapcon3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="takeAttendanceEvent.php">Take Attendance by Event</a>
        <a class="collapse-item" href="viewAttendance.php">View Event Attendance</a>
        <a class="collapse-item" href="importGFormData.php">Google Forms Attendance</a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseBootstrapcon4" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="addCandidates.php">Add Candidates</a> 
